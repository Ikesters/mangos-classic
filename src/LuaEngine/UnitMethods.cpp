...
int LuaUnit::SendMailMenu(lua_State* L, Unit* unit)
{
    ...
    WorldPacket data(SMSG_SEND_MAIL_RESULT, 8);
...
int LuaUnit::JumpToCoords(lua_State* L, Unit* unit)
{
    ...
    unit->GetMotionMaster()->MoveFlyOrLand(x, y, z, speedXY, speedZ);
    return 0;
}
...
int LuaUnit::MoveCharge(lua_State* L, Unit* unit)
{
    ...
    //unit->GetMotionMaster()->c(x, y, z, speed);
    return 0;
}
...
int LuaUnit::SetHonorPoints(lua_State* L, Unit* unit)
{
    ...
    player->AddHonorCP(honorP,HONORABLE,0,0);
    return 0;
}
